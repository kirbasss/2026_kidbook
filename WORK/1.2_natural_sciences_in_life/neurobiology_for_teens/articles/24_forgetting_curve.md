...
Связи между нейронами остаются слабыми (см. [Мозг, который умеет меняться](neuroplasticity.md)).
...
Это напрямую связано с консолидацией памяти (см. [Устройство памяти](memory_structure.md)).
